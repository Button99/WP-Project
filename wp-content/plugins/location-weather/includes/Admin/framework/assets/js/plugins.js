...
(function($) {
  ...
  function SPLWTAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SPLWTAjaxChosen.prototype.init = function() {
  ...
  SPLWTAjaxChosen.prototype.events = function() {
  ...
  SPLWTAjaxChosen.prototype.search_field_focused = function() {
  ...
  SPLWTAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SPLWTAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('splwt-lite-chosen', _this.options.data).done( function( response ) {
  ...
  SPLWTAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.splwt-lite-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SPLWTChosenOrder($hidden_value, true);
  ...
  $.fn.SPLWTAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SPLWTAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SPLWTAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SPLWTAbstractChosenOrder = (function() {

    function SPLWTAbstractChosenOrder() {}

    SPLWTAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SPLWTAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SPLWTAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SPLWTAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SPLWTAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SPLWTAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SPLWTAbstractChosenOrder.SPLWTChosenOrder = function(select, order, force) {
    ...
    return SPLWTAbstractChosenOrder;
  ...
  $.fn.extend({
    SPLWTChosenOrder: function(order, force) {
      return _SPLWTChosenOrder.SPLWTChosenOrder(this, order, force);
    }
  });

  this._SPLWTChosenOrder = (function(_super) {
    __extends(_SPLWTChosenOrder, _super);

    function _SPLWTChosenOrder() {
      _ref = _SPLWTChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SPLWTChosenOrder.relAttributeName = 'data-option-array-index';

    _SPLWTChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SPLWTChosenOrder.getDOMElement = function(element) {
    ...
    _SPLWTChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SPLWTChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SPLWTChosenOrder;

  })(SPLWTAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('splwt-lite-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('splwt-lite-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSPLWT = FormSerializer.serializeObject;
    $.fn.serializeJSONSPLWT   = FormSerializer.serializeJSON;
  }
