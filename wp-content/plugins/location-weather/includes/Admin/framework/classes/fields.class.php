...
if ( ! class_exists( 'SPLWT_Fields' ) ) {
	 ...
	 * @version 1.0.0
	 */
	abstract class SPLWT_Fields extends SPLWT_Abstract {
		...
		public function field_before() {
			return ( ! empty( $this->field['before'] ) ) ? '<div class="splwt-lite-before-text">' . wp_kses_post( $this->field['before'] ) . '</div>' : '';
		}
		...
		public function field_after() {
			...
			$output  = ( ! empty( $this->field['after'] ) ) ? '<div class="splwt-lite-after-text">' . wp_kses_post( $this->field['after'] ) . '</div>' : '';
			$output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="splwt-lite-desc-text">' . wp_kses_post( $this->field['desc'] ) . '</div>' : '';
			$output .= ( ! empty( $this->field['help'] ) ) ? '<div class="splwt-lite-help"><span class="splwt-lite-help-text">' . wp_kses_post( $this->field['help'] ) . '</span><i class="fas fa-question-circle"></i></div>' : '';
			$output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="splwt-lite-error-text">' . wp_kses_post( $this->field['_error'] ) . '</div>' : '';
