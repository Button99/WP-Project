...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211227_blog_895dbc26b7cfdb9c3831_20211227110827_archive.zip';
	const ARCHIVE_SIZE		 = '38967454';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '895dbc2-27110827';
    const SECONDARY_PACKAGE_HASH = '5fe0963-27110827';
	const VERSION			 = '1.4.3';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.3==');
		self::log('----------------------------------------------------');
